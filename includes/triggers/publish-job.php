...
class AutomatorWP_WP_Job_Manager_Publish_Job extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User publishes a job of a type', 'automatorwp-wp-job-manager-integration' ),
            'select_option'     => __( 'User publishes <strong>a job</strong> of a type', 'automatorwp-wp-job-manager-integration' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User publishes a job of %1$s %2$s time(s)', 'automatorwp-wp-job-manager-integration' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'User publishes a job of %1$s', 'automatorwp-wp-job-manager-integration' ), '{term}' ),
            ...
            'options'           => array(
                'term' => automatorwp_utilities_term_option( array(
                    'name'              => __( 'Type:', 'automatorwp-wp-job-manager-integration' ),
                    'option_none_label' => __( 'any type', 'automatorwp-wp-job-manager-integration' ),
                    'taxonomy'          => 'job_listing_type',
                ) ),
                'times' => automatorwp_utilities_times_option(),
            ),
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Job', 'automatorwp-wp-job-manager-integration' ) ),
